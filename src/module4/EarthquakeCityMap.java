...
//		earthquakesURL = "test2.atom";
		...
		System.out.println("City Point Marker: ");
		System.out.println(((PointFeature)cities.get(0)).getLocation() + " " +  cities.get(0).getProperties());
		
		System.out.println("Country Point Marker");
		System.out.println(countries.get(0).getProperties());
//		System.out.println(countries.get(0).getProperties() +" "+ ((PointFeature)countries.get(0)).getLocation());
	    ...
	    for(PointFeature feature : earthquakes) {
		  //check if LandQuake
	    	System.out.println(feature.getProperty("age"));
		  if(isLand(feature)) {
	    ...
	    System.out.println("Earthquake Point Feature");
		System.out.println(earthquakes.get(10).getProperties() +" "+ earthquakes.get(10).getLocation());
		
	    System.out.println("Quake Marker Feature");
		System.out.println(quakeMarkers.get(10).getProperties() +" "+ earthquakes.get(10).getLocation());
		
		if(earthquakes.get(10).getProperty("age").equals("Past Day")) {
			System.out.println("This is past hour project");
		}else {
			System.out.println("OTHER");
		}
		
//		LandQuakeMarker temp = new LandQuakeMarker(earthquakes.get(10));
	...
	private void addKey() {	
		...
		fill(color(217, 69, 232));
		triangle(45, 115, 55, 95, 65, 115);
		fill(color(255, 255, 255));
		ellipse(55, 138, 20, 20);
		rect(45, 160, 18, 18);
		
		fill(0, 0, 0);
		text("City Marker", 75, 110);
		text("Land Quake", 75, 138);
	...
	private void printQuakes() 
	{
		...
		for(Marker cm: countryMarkers) {
			...
			for(Marker qm: quakeMarkers) {
				...
				if(em.isOnLand && em.getProperty("country") == name) {
					landCount++;
				}
			}
			if(landCount > 0)			
				System.out.println(name + " " + landCount);
		}
